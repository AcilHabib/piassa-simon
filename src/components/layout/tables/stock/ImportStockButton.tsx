...
const ImportStockButton: FC<ImportButtonProps> = ({title}) => {
      ...
      <Dialog>
        <DialogTrigger asChild>
          <Button
            ...
            {title}
            <img src="/svgs/import.svg" className="h-4 w-4 xl:h-5 xl:w-5" />
          </Button>
        </DialogTrigger>
        <DialogContent className="max-w-max">
          <div className="flex w-screen max-w-7xl gap-1 xl:gap-2">
            ...
            <ScrollArea className="max-h-[50rem] w-full">
              <div className="w-full">
                {/* <Form productInfo={productInfo} locale={locale} /> */}
...
export default ImportStockButton;
